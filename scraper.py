...
class RealPropertyScraper:
        ...
        for url in urls_a_visiter:
            ...
            try:
                ...
                for annonce in annonces_html:
                    ...
                    # NOUVEAU : Création d'une empreinte digitale unique pour l'ID
                    unique_id = hashlib.md5((titre + lien_final).encode('utf-8')).hexdigest()[:12]

                    prop_data = {
                        "id": f"scraped_{unique_id}",
                        "title": titre[:100], 
                        ...
                        "constructible": True,
                        "description": "Annonce 100% réelle trouvée sur le web. Cliquez sur l'URL pour les détails exacts.",
    ...
    def run_pipeline(self):
        ...
        # NOUVEAU : On supprime les doublons éventuels avant l'envoi !
        unique_properties = []
        seen_ids = set()
        ...
        print(f"Bilan : {len(raw_properties)} annonces lues, {len(unique_properties)} validées uniques (> 10 200 m²).")
